...
public class VersionHelpers {
    ...
    public static boolean IsWindowsVersionOrGreater(int wMajorVersion, int wMinorVersion, int wServicePackMajor) {
        ...
        dwlConditionMask = Kernel32Lib.INSTANCE.VerSetConditionMask(dwlConditionMask, WinNT.VER_MAJORVERSION,
                (byte) WinNT.VER_GREATER_EQUAL);
        dwlConditionMask = Kernel32Lib.INSTANCE.VerSetConditionMask(dwlConditionMask, WinNT.VER_MINORVERSION,
                (byte) WinNT.VER_GREATER_EQUAL);
        dwlConditionMask = Kernel32Lib.INSTANCE.VerSetConditionMask(dwlConditionMask, WinNT.VER_SERVICEPACKMAJOR,
                (byte) WinNT.VER_GREATER_EQUAL);

        return Kernel32Lib.INSTANCE.VerifyVersionInfoW(osvi,
    ...
    public static boolean IsWindowsXPOrGreater() {
        return IsWindowsVersionOrGreater((byte) (MyWinNT.WIN32_WINNT_WINXP >>> 8), (byte) MyWinNT.WIN32_WINNT_WINXP,
                0);
    }
    ...
    public static boolean IsWindowsVistaOrGreater() {
        return IsWindowsVersionOrGreater((byte) (MyWinNT.WIN32_WINNT_VISTA >>> 8), (byte) MyWinNT.WIN32_WINNT_VISTA,
                0);
    }
    ...
    public static boolean IsWindows7OrGreater() {
        return IsWindowsVersionOrGreater((byte) (MyWinNT.WIN32_WINNT_WIN7 >>> 8), (byte) MyWinNT.WIN32_WINNT_WIN7, 0);
    }
    ...
    public static boolean IsWindows7SP1OrGreater() {
        return IsWindowsVersionOrGreater((byte) (MyWinNT.WIN32_WINNT_WIN7 >>> 8), (byte) MyWinNT.WIN32_WINNT_WIN7, 1);
    }
    ...
    public static boolean IsWindows8OrGreater() {
        return IsWindowsVersionOrGreater((byte) (MyWinNT.WIN32_WINNT_WIN8 >>> 8), (byte) MyWinNT.WIN32_WINNT_WIN8, 0);
    }
    ...
    public static boolean IsWindows8Point1OrGreater() {
        return IsWindowsVersionOrGreater((byte) (MyWinNT.WIN32_WINNT_WINBLUE >>> 8),
                (byte) MyWinNT.WIN32_WINNT_WINBLUE, 0);
    }
    ...
    public static boolean IsWindows10OrGreater() {
        return IsWindowsVersionOrGreater((byte) (MyWinNT.WIN32_WINNT_WIN10 >>> 8), (byte) MyWinNT.WIN32_WINNT_WIN10,
                0);
    }
    ...
    public static boolean IsWindowsServer() {
        ...
        long dwlConditionMask = Kernel32Lib.INSTANCE.VerSetConditionMask(0, WinNT.VER_PRODUCT_TYPE,
                (byte) WinNT.VER_EQUAL);

        return !Kernel32Lib.INSTANCE.VerifyVersionInfoW(osvi, WinNT.VER_PRODUCT_TYPE, dwlConditionMask);
    }
}
